...
@routes_api.route('/v0/chart/departure_by_ownership', strict_slashes=False)
class ChartDepartureOwnership(Resource):
    ...
    parser.add_argument('aggregate_by', type=str, action='split',
                        default=['ship_owner_country', 'ship_insurer_country', 'departure_date', 'commodity_group'],
        ...
        if format == "csv":
            return Response(
                ...
                headers={"Content-disposition":
                             "attachment; filename=departure_by_ownership.csv"})
