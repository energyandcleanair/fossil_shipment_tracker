...
def test_voyage_pricing(app):
    ...
    with app.test_client() as test_client:
        ...
        params = {"format": "json",
                  ...
                  "pricing_scenario": PRICING_PRICECAP,
        ...
        price_given = price_given.rename(columns={
        ...
        max_match = ['departure_port_id', 'destination_iso2', 'ship_owner_iso2', 'ship_insurer_iso2']
        matches = [['departure_port_id', 'destination_iso2', 'ship_owner_iso2', 'ship_insurer_iso2'],
        ...
        for match in matches:
            ...
            price_obtained = data.copy()[['data_index', 'id', 'departure_port_id', 'destination_iso2',
                                   'ship_owner_iso2', 'ship_insurer_iso2',
                                   'commodity', 'date', 'eur_per_tonne']]
            ...
            price_comparison = price_obtained.merge(price_given,
                                 on=match,
            ...
            for col in unmatching_columns:
                price_comparison = price_comparison[price_comparison[col + '_given'].isnull() |
                                                        price_comparison[col + '_given'].isna()]


            idx_already_compared += list(price_comparison.data_index)

            assert all(np.isclose(price_comparison.eur_per_tonne_given,
...
def test_price_cap(app):
    ...
    with app.test_client() as test_client:
        ...
        params = {"format": "json",
                  "date_from": date_from,
                  "commodity": ",".join(commodities),
                  "pricing_scenario": base.PRICING_PRICECAP,
                  "commodity_origin_iso2": 'RU',
                  "currency": 'EUR'
                  }
        ...
        price_obtained = price_obtained[['ship_owner_iso2', 'commodity', 'date', 'eur_per_tonne',
                                         'departure_port_id', 'destination_iso2']]
