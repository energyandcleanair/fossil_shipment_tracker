    ...
    [
        ...
        html.Div(
            [
                dbc.Button(
                    "Russia",
                    id="insurance-origin-country-select-russia",
                    color="primary",
                    className="btn-preset",
                ),
                dbc.Button(
                    "Laudromat",
                    id="insurance-origin-country-select-laundromat",
                    color="primary",
                    className="btn-preset",
                ),
            ],
        ...
        dcc.Dropdown(
            id="insurance-destination-country",
        ...
        html.Div(
            [
                dbc.Button(
                    "Laudromat",
                    id="insurance-destination-country-select-laundromat",
                    color="primary",
                    className="btn-preset",
                ),
                dbc.Button(
                    "PCC",
                    id="insurance-destination-country-select-pcc",
                    color="primary",
                    className="btn-preset",
                ),
                dbc.Button(
                    "EU-27",
                    id="insurance-destination-country-select-eu27",
                    color="primary",
                    className="btn-preset",
                ),
            ],
        ...
        html.Div(
            [
                dbc.Button(
                    "Download raw data",
                    id="btn-download-insurance0",
                    color="secondary",
                ),
                dbc.Button(
                    "Download processed data",
                    id="btn-download-insurance1",
                    color="secondary",
                ),
            ],
            className="d-grid gap-2 mt-2",
        ),
        dcc.Download(id="download-insurance0"),
        dcc.Download(id="download-insurance1"),
    ]
)
            ...
            [
                dbc.Col(
                    dcc.Loading(
                        ...
                        children=[dcc.Graph(id="insurance-area-chart", className="flex-grow-1")],
                    ),
                    className="d-flex",
                ),
            ],
