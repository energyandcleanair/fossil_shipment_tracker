...
def update(limit=None):
    ...
    dangling_departures = departure.get_dangling_departures()
    ...
    for d in dangling_departures:
        ...
        portcall = Marinetraffic.get_first_arrival_portcall(imo=imo,
        ...
        if portcall:
            data = {
                ...
                "date_utc": portcall.date_utc,
                "port_unlocode": portcall.port_unlocode
            }
